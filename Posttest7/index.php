	...
	<div class="medsos">
		<div class="container">
			<ul>
				...
				<li><a href="https://api.whatsapp.com/send/?phone=%2B6289693734979&text&type=phone_number&app_absent=0"><i class="fab fa-whatsapp"></i></a></li>
				<li><a href="https://github.com/bintangputrasadewa"><i class="fab fa-github"></i></a></li>
				<li><a href="https://instagram.com/sdewa_?igshid=MzRlODBiNWFlZA=="><i class="fab fa-instagram"></i></a></li>
			</ul>
		</div>
	</div>
